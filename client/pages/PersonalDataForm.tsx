          ...
          <div className="space-y-4">
            ...
            <div className="pt-2 space-y-3">
              ...
              <p className="text-xs text-mobile-text-secondary font-mobile-base leading-relaxed">
                Wir senden deine Daten an die [Bank Name] für Privatkunden und
                Handel GmbH und an den inserierenden Händler, um deine Anfrage
                zu beantworten und für weitere Zwecke zu verarbeiten. Als Teil
                unserer Vermittlungsleistung erinnern wir dich per E-Mail an die
                Möglichkeit zum Finanzierungsabschluss.{" "}
                <span className="underline">Datenschutzhinweis</span>
              </p>
            </div>
          </div>
        </div>
