...
export default function FinancingCalculator() {
  ...
  const getFinancingDetails = () => {
    ...
    if (finalPayment) {
      ...
      totalAmount =
        downPaymentValue + monthlyRate * termMonths + finalPaymentAmount;
    } else {
    ...
    if (finalPayment) {
      baseDetails.push({
        label: "Schlussrate",
        value: formatCurrencyDetailed(finalPaymentAmount),
      });
    }
    ...
    baseDetails.push(
      {
        ...
        value: formatCurrencyDetailed(netLoanAmount),
      },
  ...
  const faqs = [
    ...
    {
      question:
        "Was ist der Unterschied zwischen Finanzierung mit und ohne Schlussrate?",
      answer: "",
    },
    {
      question:
        "Was ist der Unterschied zwischen einer unverbindlichen Finanzierungsanfrage und einem Kreditantrag?",
      answer: "",
    },
  ];
      ...
      <header className="bg-white border-b border-mobile-border">
        <div className="flex items-center justify-between px-4 py-4">
          ...
          <div className="text-right">
            <p className="text-xs text-mobile-text-secondary font-mobile-base">
              In Kooperation mit
            </p>
            <img
              src="https://api.builder.io/api/v1/image/assets/TEMP/c462b7b571359b1258522f9c229c027793c004d7?width=78"
              alt="BDK Logo"
              className="w-10 h-4 ml-auto"
            />
          </div>
        </div>
      </header>
      ...
      <main className="px-4 py-6 space-y-6 max-w-md mx-auto lg:max-w-2xl">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-mobile-text-secondary font-mobile-base">
            Mit diesen Informationen kann dir der Händler ein maßgeschneidertes
            Angebot machen.
          </p>
        </div>
        ...
        <div className="space-y-4">
            ...
            {finalPayment && (
              <div className="text-right">
                <span className="text-sm text-mobile-text-primary font-mobile-base">
                  {financingData.finalPaymentAmount}
                </span>
              </div>
            )}
          </div>
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center border border-mobile-text-muted rounded-lg px-3.5 py-3">
              ...
              />
              <span className="text-sm text-mobile-text-secondary font-mobile-base">
                €
              </span>
            </div>
          </div>
            ...
            <div className="space-y-0">
              ...
              <div className="pt-2">
                <p className="text-xs text-mobile-text-secondary font-mobile-base leading-relaxed">
                  ...
                  das 2/3-Beispiel gem. § 17 Abs. 4 PAngV dar. Ein
                  Finanzierungsangebot der [Bank Name], [bank address]. Bonität
                  vorausgesetzt.
                </p>
              </div>
            </div>
