          ...
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <div className="w-48 h-48 mb-1">
              ...
              >
                ...
                <g>
                  {/* Left hand */}
                  <path
                    d="M100 150C100 130 120 110 140 110C160 110 180 130 180 150L180 200C180 220 160 240 140 240C120 240 100 220 100 200Z"
                    fill="#E8A882"
                  />
                  ...
                  {/* Right hand */}
                  <path
                    d="M200 150C200 130 180 110 160 110C140 110 120 130 120 150L120 200C120 220 140 240 160 240C180 240 200 220 200 200Z"
                    fill="#E8A882"
                  />
                  ...
                  <path
                    d="M150 50L152 58L160 56L152 64L150 72L148 64L140 56L148 58Z"
                    fill="#FFD700"
                  />
                  <path
                    d="M110 90L112 95L117 93L112 98L110 103L108 98L103 93L108 95Z"
                    fill="#FFD700"
                  />
                  <path
                    d="M190 95L192 100L197 98L192 103L190 108L188 103L183 98L188 100Z"
                    fill="#FFD700"
                  />
                </g>
              </svg>
            ...
            <div className="space-y-2">
              ...
              <p className="text-base text-mobile-text-primary font-mobile-base leading-6">
                Damit Du dieses Inserat schnell wiederfindest, haben wir es
                automatisch für Dich auf Deinem{" "}
