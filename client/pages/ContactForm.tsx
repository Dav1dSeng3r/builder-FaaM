        ...
        <div className="space-y-4">
          <div className="space-y-1">
            ...
            <p className="text-sm text-mobile-text-secondary font-mobile-base">
              Teile{" "}
              <span className="font-gibson">Volkswagen Automobile Dresden</span>{" "}
              mit, was Dich an diesem Fahrzeug interessiert.
            </p>
          </div>
            ...
            <div className="flex gap-18">
              <div className="flex items-center gap-2">
                ...
                >
                  <div className="w-6 h-6 flex items-center justify-center">
                    <div
                      className={`w-5 h-5 rounded-full border ${formData.salutation === "herr" ? "border-2 border-mobile-purple bg-mobile-purple" : "border border-mobile-text-muted bg-white"}`}
                    >
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  <div className="w-6 h-6 flex items-center justify-center">
                    <div
                      className={`w-5 h-5 rounded-full border ${formData.salutation === "frau" ? "border-2 border-mobile-purple bg-mobile-purple" : "border border-mobile-text-muted bg-white"}`}
                    >
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-mobile-text-secondary font-mobile-base">
                    Anzahlung · Wunschlaufzeit · Wunschrate{" "}
                    <span className="underline">Eingeben</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="border border-mobile-border rounded-lg p-4">
              <div className="flex items-center gap-2">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-mobile-text-secondary font-mobile-base">
                    0 € Anzahlung · 48 Monate · 10.000 km pro Jahr · 6,30 % eff.
                    Jahreszins
                  </div>
                </div>
              </div>
          ...
          <div className="text-xs text-mobile-text-secondary font-mobile-base leading-relaxed">
            ...
            <span className="underline">Mehr</span>
            <br />
            <br />
            Deine Nachricht wird von mobile.de zum Schutz vor verbotenen
            Aktivitäten vor der Weiterleitung an den Empfänger geprüft und ggf.
            blockiert. Im Anschluss erhältst Du eine Email zu der gewünschten
            Finanzierungsmöglichkeit des Fahrzeugs. Du erhältst ggf. eine
            E-Mail-Einladung zur Teilnahme an einer Händlerbewertung. Du kannst
            dem Erhalt jederzeit widersprechen. Mit Absenden dieser Nachricht
            erklärst Du Dich mit diesem Vorgehen und dem Erhalt der
            E-Mail-Einladung einverstanden. Für weitere Informationen lies bitte
            unsere <span className="underline">Datenschutzerklärung</span>
          </div>
        </div>
      </main>
      ...
      <footer className="bg-mobile-bg-dark px-4 py-8 space-y-4">
        <div className="space-y-2 pb-4">
          {[
            ...
            <div
              key={link}
              className="text-sm text-mobile-text-light font-gibson"
            >
              {link}
            </div>
          ))}
